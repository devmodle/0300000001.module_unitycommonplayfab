...
#region 프로퍼티
	...
	public string UserID => m_oStrDict.GetValueOrDefault(EKey.USER_ID, string.Empty);
...
#region 클래스 함수
	...
	public static STParams MakeParams(Dictionary<ECallback, System.Action<CPlayfabManager, bool>> a_oCallbackDict = null) {
		return new STParams() {
			m_oCallbackDict = a_oCallbackDict ?? Dictionary<ECallback, System.Action<CPlayfabManager, bool>>()
		};
	}
#endregion         // 클래스 함수                   
